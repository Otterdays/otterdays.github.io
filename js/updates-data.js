...
const UPDATES_DATA = [
  {
    ...
    date: "TBD",
    sections: [
      { type: "added", items: ["Tools (Coding Assistants): Codeium (forever-free AI coding), Continue (open-source, model-agnostic).", "Tools (Reference): MCP Directory (10,000+ MCP servers).", "Media (Video): Kling (Kuaishou), LTX Video (Lightricks).", "Specials: New section Free AI coding — Gemini Code Assist (free), p5js AI.", "Chats: Llama 4 (Meta open-source multimodal).", "Companies: Codeium (Codeium + Windsurf), Continue, Kuaishou (Kling), Lightricks (LTX Video).", "Search index and badges updated for all new entries."] }
    ]
  },
  {
    version: "1.8.3",
