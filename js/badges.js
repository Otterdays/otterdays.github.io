...
(function () {
    ...
    var COUNTRY_MAP = {
        ...
        'Upstage': KR, 'Nex-AGI': CN, 'Kyutai': FR, 'GDevelop': CH, 'IBM': USA,
        ...
        'LongCat': CN, 'ZenMux': USA, 'Qoder': USA, 'OpenCode': USA, 'OpenCode Desktop': USA, 'OpenCode Zen': USA, 'Obsidian': CA, 'Kilo': USA, 'Roo Code': USA,
        ...
        'Nex-AGI': CN, 'Nex-N2 (GitHub)': CN, 'Nex-AGI (Hugging Face)': CN,
        'Moshi': FR, 'Unmute': FR, 'Kyutai (GitHub)': FR, 'Kyutai (Hugging Face)': FR,
        ...
        'Allen AI (Ai2)': USA, 'Cohere Chat': CA, 'North': CA, 'Deep Agent': USA, 'Anything': USA,
        'SubQ API': USA, 'SubQ Code': USA, 'SubQ Search': USA,
        ...
        'SpacetimeDB': USA, 'Clockwork Labs': USA,
        'Adobe Firefly': USA, 'Amazon Q': USA, 'Higgsfield Assist': USA, 'Qoder CLI': USA,
        'Kilo Code': USA, 'vLLM (vllm.ai)': USA, 'Yandex AI': RU, 'Yandex Games': RU, 'Pi': USA, 'Groq Cloud': USA,
        ...
        'Llama': USA, 'Manus': USA, 'Mobbin': UK, 'Meta AI': USA, 'Muse Code': USA, 'Azure OpenAI': USA, 'Copilot': USA,
        'GitHub Copilot': USA, 'Grok': USA, 'Grok Bot': USA, 'Grok Build': USA, 'Le Chat': FR, 'Mistral Vibe': FR, 'Amazon Nova': USA,
        ...
        'GoLand': { flag: '\uD83C\uDDE8\uD83C\uDDFF', label: 'Czech Republic' }, 'RustRover': { flag: '\uD83C\uDDE8\uD83C\uDDFF', label: 'Czech Republic' },
        'CLion': { flag: '\uD83C\uDDE8\uD83C\uDDFF', label: 'Czech Republic' },
        ...
        'Windsurf': USA, 'Z Code': USA, 'cmux': USA, 'Ghostty': USA, 'Fresh': USA, 'Orbiton': NO,         'Visual Studio Code': USA, 'Void': USA,
