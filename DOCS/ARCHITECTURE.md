...
**Current release:** v1.11.0 (version badge in top bar → `updates.html`). [AMENDED 2026-06-10]
...
- **Top Bar:** Version badge (v1.11.0 → `updates.html`), Search, Theme switcher. [AMENDED 2026-06-10]
