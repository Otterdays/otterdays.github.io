...
**Live site:** [https://otterdays.github.io/](https://otterdays.github.io/) · **Current version:** [v1.13.0](https://otterdays.github.io/updates.html) (see `DOCS/CHANGELOG.md`)
...
| `updates.html` | Version history (e.g. v1.13.0), timeline UI |
...
├── js/updates-data.js      # Changelog entries (v1.13.0, …)
