...
**Live site:** [https://otterdays.github.io/](https://otterdays.github.io/) · **Current version:** [v1.12.0](https://otterdays.github.io/updates.html) (see `DOCS/CHANGELOG.md`)
...
├── js/updates-data.js      # Changelog entries (v1.12.0, …)
